...
SEPHER (Socio-Economic Physical Housing Eviction Risk) focuses on identifying the populations (assessing impacts of climate-related hazards on the most vulnerable communities) to study in order to effectively provide sufficient aid. The SEPHER datasets combine data from the Social Vulnerability Index, FEMA’s National Risk for Natural Hazards, Home Mortgage Disclosure Act, the Eviction Lab at Princeton University, and trends of rental prices for properties. This data is used rather than commercial data because it is publicly available and does not cost the expensive price of purchasing commercial data. (Fecht, 2021). SURF (Stanford Urban Risk Framework) is a dataset that focuses on the populations most vulnerable to having their livelihoods destroyed by flooding, by utilizing “a human-centered approach to risk assessment” (Torrent, 2021). Researchers identified communities close to a fiscal tipping point and assessed their financial instability.  
  
## Closing Thoughts
  
 
Overall, climate justice is a movement that aims to help everyone as climate issues expose our collective society’s vulnerabilities, even if certain populations are hit harder. As a society, we need to stay proactive and remain vigilant on climate change, especially on how it impacts minority groups such as low-income communities, people of color, people with disabilities, and indigenous groups. Hurricane Harvey, a disaster just four years ago, was low-income and BIPOC (Black and Indigenous People of Color), with over 50% of the population affected. Beyond the U.S., in Berlin, there is a significant correlation between each of the city’s planning area’s social class and air pollution. Incorporating demographic, real estate, financial data and more enables us to be socially aware of these non-coincidental trends. Data reveals specific areas of groups that are or could be disproportionately impacted by global environmental factors. However, data alone cannot solve this problem. Data is an important step but research studies and community engagement are crucial to taking a stance on climate justice. Data provides insights, but it cannot act on these insights - that starts with Us. 
